...
def test_schema_validation_core_types_to_bigquery():
    ...
    schema_validation_test(
        ...
        allow_list=(
            ...
            "timestamp(7):timestamp,!timestamp(7):!timestamp,timestamp(7, 'UTC'):timestamp('UTC'),timestamp('UTC', 7):timestamp('UTC'),"
        ),
    )
...
def test_schema_validation_ss_types_to_bigquery():
    ...
    schema_validation_test(
        ...
        allow_list=(
            ...
            "timestamp(7):timestamp,timestamp(7, 'UTC'):timestamp('UTC'),timestamp('UTC', 7):timestamp('UTC')"
        ),
...
def test_schema_validation_not_null_vs_nullable():
    ...
    args = parser.parse_args(
        [
            ...
            # SQL Server TIMESTAMP type has scale=7 on Ibis which does not happen in BigQuery.
            "--allow-list=timestamp(7):timestamp,!timestamp(7):!timestamp,timestamp(7, 'UTC'):timestamp('UTC'),timestamp('UTC', 7):timestamp('UTC'),",
        ]
    )
